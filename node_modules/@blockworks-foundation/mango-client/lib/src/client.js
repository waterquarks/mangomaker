...
class MangoClient {
    ...
    cancelAllSpotOrders(mangoGroup, mangoAccount, spotMarket, owner, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!owner.publicKey)
                return;
            ...
            const instruction = (0, instruction_1.makeCancelAllSpotOrdersInstruction)(this.programId, mangoGroup.publicKey, mangoGroup.mangoCache, mangoAccount.publicKey, owner.publicKey, baseRootBank.publicKey, baseNodeBanks[0].publicKey, baseNodeBanks[0].vault, quoteRootBank.publicKey, quoteNodeBanks[0].publicKey, quoteNodeBanks[0].vault, spotMarket.publicKey, spotMarket.bidsAddress, spotMarket.asksAddress, mangoAccount.spotOpenOrders[spotMarketIndex], mangoGroup.signerKey, spotMarket['_decoded'].eventQueue, spotMarket['_decoded'].baseVault, spotMarket['_decoded'].quoteVault, dexSigner, mangoGroup.dexProgramId, new bn_js_1.default(limit));
            const transaction = new web3_js_1.Transaction();
            transaction.add(instruction);
